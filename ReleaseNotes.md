...
1. Ignores unknown properties
2. Updates for unknown Fields in Meta
3. Library updates
4. Parallelization support for multiple sub-report frameworks like Codacy 
5. Parallelization support for multiple sub-report frameworks like Codacy (DO NOT USE THIS VERSION)
